...
/**
 * Класс реализующий простой неблокирующий Socks 4 Proxy Сервер Реализуюший только команду connect
 *
 * @author dgreen
 * @date 19.09.2009
 * @see <a href="http://habrahabr.ru/post/70690/">Java: Socks 4 Proxy работа с неблокирующими сокетами</a>
 */
public class Socks4Proxy implements Runnable {
    ...
    /**
     * Функция принимает соединение, регистрирует ключ с интересуемым действием чтение данных (OP_READ)
     *
